...
bot.on("guildMemberAdd", function(member)
{
    member.send(
        ...
        "\t\t- Enjoy yourself.\n" +
        "If you want to join your team please use ;joinRole + your team's general number (ex. 905, 5225, 200, 356)\n" + 
        "If you also want to add your team role please use ;joinRole + your role(ex. programmer, captain, engineer, scout)\n" +
        "If you have any issues with this bot please dm Carson from team NXS for assistance!" 
